...
concommand.Add("EntCheck", function(ply)
print("Model: " .. ply:GetEyeTrace().Entity:GetModel())
print("Class: " .. ply:GetEyeTrace().Entity:GetClass())
print(ply:GetEyeTrace().Entity:GetPos()) // Position, but no text because LUA wants to be dumb
end)
